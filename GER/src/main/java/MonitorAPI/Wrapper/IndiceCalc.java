...
import MonitorAPI.LogServer.GetMethodname;
...
public class IndiceCalc {
    ...
    public static float IDcalculator(float[] Metrics) throws IOException, SQLException {
        ...
        System.out.println("Indice de Consumo entre 0-1:" + (df.format(icfinal/100)) );
        ...
        return icfinal/100; /*indice de desempenho final representado entre 0 e 1*/
    }
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        //   System.out.println(Wrapper.DstatRequest());
